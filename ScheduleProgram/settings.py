"""
Django settings for ScheduleProgram project.
...
ROOT_URLCONF = 'ScheduleProgram.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [Path.joinpath(BASE_DIR,'dist/')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'ScheduleProgram.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    Path.joinpath(BASE_DIR,'dist/static' )
]
